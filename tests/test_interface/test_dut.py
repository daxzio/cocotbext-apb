"""
test_basic-style test using cocotbext-interface style APB (Apb4Interface).
The only difference from test_basic is the bus object: Apb4Interface instead
of ApbBus.  ApbHost and ApbMonitor are used unchanged.
"""
...
class testbench:
    def __init__(self, dut, reset_sense=1, period=10):
        ...
        apb_prefix = "s_apb"
        self.bus = Apb4Interface.from_prefix(dut, apb_prefix)
        clk_name = "clk"
