...
async def test_apb_pprot(dut):
    ...
    await tb.m.read(0x1000, 0x00000000, prot=ApbProt.NONSECURE, error_expected=False)

    await tb.m.write(0x1000, 0x52346325, prot=ApbProt.NONSECURE, error_expected=False)
    await tb.m.read(0x1000, 0x74568562, prot=ApbProt.PRIVILEGED)
    ...
    await tb.m.read(0x2000, 0x00000000, prot=ApbProt.NONSECURE, error_expected=False)
